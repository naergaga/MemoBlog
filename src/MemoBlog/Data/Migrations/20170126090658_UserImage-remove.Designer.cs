...
namespace MemoBlog.Data.Migrations
{
    ...
    [Migration("20170126090658_UserImage-remove")]
    partial class UserImageremove
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MemoBlog.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MemoBlog.Models.Post", b =>
                {
                    b.HasOne("MemoBlog.Models.Category", "Category")
                        .WithMany()
